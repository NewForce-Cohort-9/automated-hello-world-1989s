...
const japanData = {
    japanCelebrities : [
        {
            ...
            fact: "Ken Watanabe: He's acted in movies"
        ...
        },
        {
            ...
            fact: "Shinji Kagawa: He kicks a ball into a net"
        ...
        },
        {
            ...
            fact: "Naomi Osaka: She hits a ball over a net"
        ...
        },
        {
            ...
            fact: "Yuzuru Hanyu: He slides around on some ice and wins medals"
    ...
    japanLandmarks: [
        {
            ...
            deathToll: "Shinsaibashi-suji Shopping Street, death toll: 991"
        ...
        },
        {
            ...
            deathToll: "Tokyo National Museum, death toll: 432"
        },
       {
        ...
        deathToll: "Botanic Garden Hokkaido University, death toll: 1589"
       },
       {
        name: "Kuromon Market",
        image: "https://static.gltjp.com/glt/prd/data/directory/12000/11898/20220102_232524_06e595a3_w1920.jpg",
        deathToll: "Kuromon Market, death toll: 943"
       }
    ...
    japanCities: [
        ...
        },
        {
            ...
            crimeIndex: "Tokyo, crime index: 24.79%"
        } 
    ]
}
...
const peruData = {
    landmarks: [
        { 
            name: "Machu Picchu", 
            deathToll: 53429,
            imageUrl: "./scripts/peru/PeruImages/machu picchu.jpg"
        },
        { 
            name: "Nazca Lines", 
            deathToll: 643,
            imageUrl: "./scripts/peru/PeruImages/Nazca Lines.jpg"
        },
        { 
            name: "Cusco Historic Center", 
            deathToll: 791328,
            imageUrl: "./scripts/peru/PeruImages/Cusco Historic Center.jpg"
        },
        { 
            name: "Lake Titicaca", 
            deathToll: 1,
            imageUrl: "./scripts/peru/PeruImages/Lake Titicaca.jpg"
        }
    ],
    celebrities: [
        { 
    ...
    cities: [
        { 
            name: "Callao", 
            dangerRate: 75.4,
            imageUrl: "./scripts/peru/PeruImages/Callao.jpg"
        },
        { 
            name: "Trujillo", 
            dangerRate: 5.0,
            imageUrl: "./scripts/peru/PeruImages/Trujillo.jpg"
        },
        { 
            name: "Lima", 
            dangerRate: 82.2,
            imageUrl: "./scripts/peru/PeruImages/Lima.jpg"
        },
        { 
            name: "Chimbote", 
            dangerRate: 16.9,
            imageUrl: "./scripts/peru/PeruImages/Chimbote.jpg"
        }
    ]
}
